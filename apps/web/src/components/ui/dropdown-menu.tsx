...
/**
 * A menu that appears when a user interacts with a trigger element.
 */
...
/**
 * A submenu that appears when a user hovers over a trigger item.
 */
